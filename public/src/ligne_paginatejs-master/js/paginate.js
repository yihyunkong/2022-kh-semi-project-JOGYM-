...
import {initDataService} from '../../board/list_module.js';
import {adminDataService} from '../../admin/admin-data.js';

export function lignePaginate(){
    console.log("lignePaginate() 함수 호출 성공");
